...
def server(addressPort, socket, id):
	...
	r1_to_s_costs = open("r1_to_s_costs.txt", "w+")
	r1_to_d_costs = open("r1_to_d_costs.txt", "w+")
	r1_to_r2_costs = open("r1_to_r2_costs.txt", "w+")
